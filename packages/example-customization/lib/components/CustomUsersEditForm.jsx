import { Components, replaceComponent, withCurrentUser, withMessages } from 'meteor/vulcan:core';
...
replaceComponent('UsersEditForm', UsersEditForm, withMessages, withCurrentUser);
